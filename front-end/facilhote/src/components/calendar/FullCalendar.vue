  ...
  <div class="comp-full-calendar">
    ...
    <div class="full-calendar-body">
      ...
      <div class="dates" ref="dates">
        <div class="dates-bg">
          <div class="week-row" v-for="(week, i) in currentDates" :key="`${i}-${week.index}`">
            <div
              class="day-cell"
              v-for="(day, i) in week"
              :key="`${i}-${day.id}`"
        ...
        <div class="dates-events">
          <div class="events-week" v-for="(week, i) in currentDates" :key="`${i}-${week.index}`">
            <div
              class="events-day"
              v-for="(day, i) in week"
              :key="`${i}-${day.index}`"
        ...
        >
          ...
          <div class="more-body">
            <ul class="body-list">
              <li
                v-for="(event, i) in selectDay.events"
                :key="`${i}-${event.id}`"
                v-show="event.isShow"
                class="body-item"
...
export default {
  ...
  methods: {
    ...
    getCalendar() {
      ...
      let monthViewStartDate = this.getMonthViewStartDate(
        this.currentMonth,
        this.firstDay
      );
      let calendar = [];
